...
ログインに関係なく、店舗一覧画面より閲覧とお気に入り機能が利用できます。<br>
...
「詳しくみる」ボタンをクリックすると、店舗詳細画面に移動します。<br>
店舗詳細画面では、お店の詳細閲覧と予約ができます。<br>
未ログインでは、予約ができません。

![お店詳細画面](<スクリーンショット 2025-02-06 120132.png>)

予約は、明日以降となるようにバリデーションによる機能がついています。<br>
また、予約すると利用者として登録しているメールアドレスに、予約完了メールが届きます。<br>
予約完了メールには、QRコードが添付されており、店舗側と照合することができます。<br>
そして、予約完了画面へと移動します。<br>
...
マイページ画面より、予約状況とお気に入り店舗が管理できます。<br>
...
作成した店舗の情報は、一覧として表示できます。<br>
オーナーは、複数の店舗の代表になれます。<br>
...
QRコードをクリックすると、利用者と照会できるようにQRコードが表示されます。<br>
